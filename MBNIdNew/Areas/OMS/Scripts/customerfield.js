var saveCustomerField = $.extend(saveCustomerField, {
    init: function () {
        $("#btnSave").on('click', saveCustomerField.saveOnClick);
    },
...
$("#btnDelete").click(function () {
    ...
    swal({
        ...
        if (isConfirm) {
            $.ajax({
                url: "/OMS/CustomerField/DeleteCustomerField/",
                data: { id: $("#CustomerFieldID").val() },
                method: "POST",
